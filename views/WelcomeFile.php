      ...
      <div class="container">
        <div class="row">
          <div class="col text-start">
            <a href="WelcomeFile.php" class="btn btn-primary btn-sm btn-brand">CrismileMx</a>
          </div>
          <div class="col text-end">
            <a href="Register.php" class="btn btn-primary btn-sm btn-secondary-custom">Hazte una cuenta</a>
            <a href="Login.php" class="btn btn-primary btn-sm btn-secondary-custom">Inicia Sesion</a>
          </div>
        </div>
        <div class="row">ㅤ</div>
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#maquillaje">Maquillaje</a>
                  </li>
                </ul>
        ...
        <div class="container">
          <div class="row text-start" id="maquillaje">
            <div class="col">
              ...
              <p>Escoja un tipo de maquillaje depende de la ocasión</p>
              <hr>
            </div>
          </div>
        </div>
