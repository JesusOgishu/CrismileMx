...
<html lang="en">
  ...
  <body>
    ...
    <div class="header">
      <div class="container">
        ...
        <div class="row text-start">
          <div class="col">
            <h1 id=main-title>¿Necesitas trabajos de fotografia?</h1>
    ...
    <!-- Contenido principal (estructura similar a WelcomeFile) -->
    <div class="fondo-imagen">
      <div class="container">
        ...
        <div class="row text-start" id="nuestros-servicios">
          <div class="col">
            <h3 class="section-heading">Toma de fotografias</h3>
        ...
        <div class="item1">
          ...
          <div class="div-imagen">
            <a href="boda.html" class="img-link">
          ...
          <div class="div-imagen">
            <a href="bautizo.html" class="img-link">
          ...
          <div class="div-imagen">
            <a href="evento.html" class="img-link">
          ...
          <div class="div-imagen">
            <a href="graduacion.html" class="img-link">
          ...
          <div class="div-imagen">
            <a href="madres.html" class="img-link">
    ...
    <div class="container">
        <div class="row text-start" id="nuestros-servicios">
            <div class="col">
              ...
              <p>Escoja un tipo de maquillaje depende a la ocasion</p>
              <hr>
            </div>
          </div>
        </div>
